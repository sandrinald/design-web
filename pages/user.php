...
<div id="label-page"><h3><center>Data User/Pengguna</center></h3></div>
<div id="content">
	
	<p id="tombol-tambah-container"><a href="index.php?p=user-input" class="tombol"><button type="button" class="btn btn-dark">Upload Data</button></a>
